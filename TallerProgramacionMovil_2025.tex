...
    \begin{itemize}        
        \item \textbf{Mecánica y Tablero}
        \begin{itemize}
            \item Es un juego para \textbf{dos jugadores} que se desarrolla en un tablero de \textbf{$3 \times 3$} casillas.
            \item Un jugador marca con \faX\ ("equis") y el otro con \faO\ ("círculo").
        \end{itemize}

        \item \textbf{Objetivo del Juego}
        \begin{itemize}
...
        \item \textbf{Desarrollo de la Partida}
        \begin{itemize}
...
        \begin{itemize}
            \item Debido al pequeño tamaño del tablero, con un \textbf{juego perfecto} por ambos bandos, el resultado inevitable es siempre un \textbf{empate}.
