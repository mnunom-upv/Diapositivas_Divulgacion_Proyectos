...
#myArray=('2025_RubikCode_Grafo')
#myArray=('2025_MapaMunicipiosTamaulipas')
#myArray=('2024_SkeletalAnimation')
#myArray=('2025_SkinReplacement')
#myArray=('2025_CambioFondoTiempoREal')
#myArray=('2025_MapaMuniciosMexico')

#myArray=('2025_RompecabezasMexico')

#myArray=('2025_RubikCode_Grafo' '2025_MapaMunicipiosTamaulipas' '2024_SkeletalAnimation' '2025_SkinReplacement' '2025_CambioFondoTiempoREal' '2025_MapaMuniciosMexico' '2025_RompecabezasMexico')
myArray=('2025_RompecabezasMexico')
