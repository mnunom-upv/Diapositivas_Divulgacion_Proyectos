...
\begin{frame}{¿Qué es MediaPipe?}
    \begin{itemize}
        \item Es una biblioteca de código abierto de Google para generar soluciones de procesamiento de video en tiempo real.
        \item Soporta múltiples plataformas como Android, iOS, y Python.
    \end{itemize}
    Soluciones existentes:
    \begin{enumerate}
        \item Detección de las partes del cuerpo humano (cara, pose, manos).
