...
%\input{2018_AugmentedReality/T14.tex} % NO HAY DEMO!!
%\input{2019_RealidadAumentada/RealidadAumentada.tex} % No HAY DEMO
...
\input{2022_MapaUPV_RealidadAumentada/MapaUPV_RealidadAumentada.tex}

% To Do: Agregar los Recorridos de la Casa del Arte, del Museo Regional y de la Pinacoteca
\input{2021_RecorridoUPV/RecorridoUPV.tex}

% To Do: Agregar las aplicaciones para detectar ejercicios (Sentadillas, Abdoiminales, etC)

\input{2023_ManoRobotica/ManoRobotica.tex}

% To Do: Agregar los simuladores Roboticos desarrollados por Melchor y Otros
