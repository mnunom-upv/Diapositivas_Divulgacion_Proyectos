...
\begin{frame}{Recorridos Virtuales}
\textbf{}
\begin{itemize}
\item Los recorridos son proyectos de materia (Programación Móvil o Desarrollo de Aplicaciones Móviles según la generación). 
\item Principalmente desarrollados por estudiantes de la carrera de Ingeniería en Tecnologías de la Información (ITI) / Ingeniería en Tecnologías de la Información e Innovación Digital (ITIID) de la Universidad Politécnica de Victoria.
...
\item El bajo costo para cargar la app en la tienda de aplicaciones (Una cuota de 25 USD te da derecho a cargar aplicaciones de manera vitalicia).  
\end{itemize}
