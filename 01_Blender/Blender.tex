...
\begin{frame}{¿Qué es Blender?}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=0.6\linewidth]{blender_logo.png}
    \end{center}
\end{frame}
...
\begin{frame}{Funcionamiento de Blender}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=0.6\linewidth]{blender_interface.png}
    \end{center}
\end{frame}
...
\begin{frame}{Aplicaciones de Blender}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=0.6\linewidth]{blender_example.png}
    \end{center}
\end{frame}
